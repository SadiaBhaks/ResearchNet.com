...
const { darkMode } = useDarkMode();
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black pb-20" style={{ background: darkMode ? primaryGradient.dark : primaryGradient.light }}>

  {/* Header */}
  <div className="bg-white dark:bg-[#111] border-b border-slate-200 dark:border-zinc-800 pt-12 pb-8 mb-8" style={{ background: darkMode ? primaryGradient.dark : primaryGradient.light }}>
    <div className="max-w-5xl mx-auto px-6">
      ...
      <h1 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight" style={{color: darkMode ? secondaryColor.dark : secondaryColor.light}}>
        Research Library
      </h1>
...
darkMode ? 'border-white' : 'border-black' 
          ...
          >
            {/* Left Side */}
            <div className="p-6 md:w-1/3 border-b md:border-b-0 md:border-r border-white/10 bg-white/5 backdrop-blur-lg">

              <div className="flex items-center gap-2 mb-3">
                <span className={`text-[10px] font-black uppercase tracking-widest  px-2 py-1 rounded ${
darkMode ? "text-purple-600 bg-purple-50" : "text-blue-600 bg-blue-50"
}`}>
                  {note.trendLevel}
                </span>
              </div>
