...
style={{ background: darkMode ? primaryGradient.dark : primaryGradient.light }}>
  ...
  <div className="relative max-w-7xl mx-auto">
    ...
    <motion.h2
      ...
      transition={{duration:0.7}}
      className={`text-4xl md:text-5xl font-black text-center mb-24  ${
...
<Link
  href="/research"
  className=" mb-10 rounded-2xl font-bold text-lg text-white  transition relative inline-flex items-center"
  style={{
