    ...
    <>
      ...
      >
        <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-zinc-800">
          <span className="text-lg font-black uppercase tracking-tighter dark:text-white"> Menu</span>
          <button
            onClick={() => setSidebarOpen(false)}
         ...
         <div className="h-[700px]">
          ...
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-4 p-4">Navigation</p>
          <Link
            href="/"
            onClick={() => setSidebarOpen(false)}
            className="flex items-center gap-3 p-4 rounded-lg hover:bg-gray-100 dark:hover:bg-zinc-800 transition-all font-medium dark:text-white"
          >
            Home
          </Link>
          <Link
